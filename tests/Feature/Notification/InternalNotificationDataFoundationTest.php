...
class InternalNotificationDataFoundationTest extends TestCase
{
    ...
    {
        $this->assertSame(['help_application_submitted', 'help_application_approved', 'help_application_rejected'], array_column(InternalNotificationEventType::cases(), 'value'));
        $this->assertSame(['applicant', 'administrator'], array_column(InternalNotificationAudience::cases(), 'value'));
        $this->assertSame(['help_application_submission_confirmation', 'help_application_new_submission', 'help_application_approved', 'help_application_rejected'], array_column(InternalNotificationType::cases(), 'value'));
