...
class InternalNotificationDataFoundationTest extends TestCase
{
    ...
    {
        $this->assertSame(['help_application_completed', 'aid_delivery_started', 'aid_delivery_problem_recorded', 'aid_delivery_resumed', 'aid_delivery_simulated_delivered', 'coordination_started', 'coordination_response_submitted', 'coordination_changes_requested', 'coordination_message_available', 'coordination_confirmed', 'campaign_funding_completed', 'help_application_campaign_activated', 'help_application_submitted', 'help_application_approved', 'help_application_rejected'], array_column(InternalNotificationEventType::cases(), 'value'));
        $this->assertSame(['applicant', 'administrator'], array_column(InternalNotificationAudience::cases(), 'value'));
        $this->assertSame(['help_application_completed', 'aid_delivery_started', 'aid_delivery_problem_recorded', 'aid_delivery_resumed', 'aid_delivery_simulated_delivered', 'coordination_started', 'coordination_response_submitted', 'coordination_changes_requested', 'coordination_message_available', 'coordination_confirmed', 'campaign_funding_completed', 'help_application_campaign_activated', 'help_application_submission_confirmation', 'help_application_new_submission', 'help_application_approved', 'help_application_rejected'], array_column(InternalNotificationType::cases(), 'value'));
